...
app.get('/api/health', (_req, res) => {
  ...
  res.json({
    ...
    redrawFallbackModel: redrawConfig.fallbackModel,
    redrawSafetyModel: redrawConfig.safetyModel,
    redrawPromptProfile: redrawConfig.promptProfile,
    redrawSafetyEnabled: redrawConfig.safetyEnabled,
    redrawImageSize: redrawConfig.imageSize,
    redrawReasoningEffort: redrawConfig.reasoningEffort,
    redrawBackgroundMode: redrawConfig.backgroundMode,
