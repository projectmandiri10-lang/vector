...
process.env.READY_TRACE_MIN_LONGEST_SIDE ||= '600';
process.env.READY_TRACE_IDEAL_LONGEST_SIDE ||= '1500';
process.env.READY_TRACE_MIN_CONTRAST ||= '18';
process.env.READY_TRACE_MIN_BLUR_SCORE ||= '22';
process.env.READY_TRACE_MAX_NOISE_SCORE ||= '42';
process.env.LOGO_RESTORE_MAX_NOISE_SCORE ||= '42';
